...
__ http://packages.python.org/python-lnovaclient/
...
Installing this package gets you a shell command, ``lnova``, that you
...
``lnova help``::
    ...
    usage: lnova [--username USERNAME] [--apikey APIKEY] [--projectid PROJECTID]
...
By way of a quick-start::
    ...
    >>> nt = client.Client(USERNAME, API_KEY, TENANT, AUTH_URL)
    >>> nt.flavors.list()
    [...]
    >>> nt.servers.list()
    [...]
...
[PENDING] See `the release notes <http://packages.python.org/python-lnovaclient/releases.html>`_.
